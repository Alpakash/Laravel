...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <h1 class="text-center mb-5">{{count($battles)}} {{$battles[0]->game_name}} battles             <a class="btn btn-primary" href="{{url('/battles/3/create')}}">Play GOT <img src="{{$battles[0]->img}}" width="40px" style="margin-left:5px;"></a>
        </h1>

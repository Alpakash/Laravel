...
<a href="http://127.0.0.1:8000/register?email={{$email}}&hash={{$hash}}">Klik op deze link</a>
http://127.0.0.1:8000/register?email={{$email}}&hash={{$hash}}
<p>Best Regards</p>
<p><strong>Carcassone 2018</strong></p>